...
| when U and (not U.invisible or U.owner.id><$site.human.id):
  ...
  | Fat = if U.fatigue then "Fatigue:[U.fatigue]-[U.fatigue_dec] "
          else ""
  | Stm = "Stamina:[U.stamina-U.stamina_fatigue]/[U.stamina]"
  | Stats <= "[Stats] Atk:[U.atk] Def:[U.def]/[U.class.def][DI] [Fat][Stm]"
